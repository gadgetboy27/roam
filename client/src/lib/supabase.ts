...
const SUPABASE_URL: string =
  import.meta.env.VITE_SUPABASE_URL || "https://znqbnldsalsfpraiplxz.supabase.co";
const SUPABASE_ANON_KEY: string =
  import.meta.env.VITE_SUPABASE_ANON_KEY || "sb_publishable_44RJuBDdm7vJx4XfeHzMpg_MeSjC1Ay";
